...
public class UserServiceImpl implements UserService{
	...
	public User save(UserRegistrationDto registrationDto) {
		User user = new User(registrationDto.getFirstName(), 
				registrationDto.getContact(), registrationDto.getEmail(),
				passwordEncoder.encode(registrationDto.getPassword()),registrationDto.getVote(),  Arrays.asList(new Role("ROLE_USER")));
